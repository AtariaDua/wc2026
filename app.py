...
if market_mode == "🔥 Сливки Дня (Ready Bets)":
    ...
    if len(express_pool) >= 2:
        ...
        **🔥 Готовый экспресс сформирован! Общий коэффициент: {total_odds}**
        ...
        st.info("🟢 Надежных трендов для экспресса в этом туре нет.")
    ...
    if not profitable_ordinars.empty:
        ...
        st.info("🟢 Крупных ошибок букмекера (валуев от +3%) в этом туре не найдено. Используйте 'ИИ-Экспресс Дня'.")

# --- ОСТАЛЬНЫЕ ЭКРАНЫ СКРИНИНГА ГРУПП ---
